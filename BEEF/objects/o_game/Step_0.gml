...
if(global.GPT3_startup_idea_received){
	...
	show_debug_message("XXXXXXX IN O_GAME STEP LOOP -- Startup idea received XXXXXXXXXXXXXXXX")
...
if(global.GPT3_startup_insults_received){
	show_debug_message("XXXXXXX IN O_GAME STEP STEP LOOP -- Startup Insults received XXXXXXXXXXXXXXXX")
...
if(global.twitter_bio_received && global.twitter_tweets_received){
	...
	show_debug_message("XXXXXXX IN O_GAME STEP STEP LOOP -- TWITTER BIO RECEIVED XXXXXXXXXXXXXXXX")
