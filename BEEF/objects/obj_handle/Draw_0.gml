...
draw_text(x,y-16,"Insert rival's twitter handle")
draw_text(x,y,global.var_handle)
draw_text(x,y+32,"Your startup is:")
draw_text(x,y+48,global.GPT3_startup_idea_name)
draw_text(x,y+64,global.GPT3_startup_idea_business_model)
	...
	totalWidthNeeded<288)
		{
		draw_text_ext(x,y+80,global.GPT3_startup_idea_explanation,8,288);
		}